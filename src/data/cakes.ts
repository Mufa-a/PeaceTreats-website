...
export const CAKES: Cake[] = [
  ...
  {
    id: 'bd-003',
    name: 'Midnight Velvet Number Cake',
    category: 'birthday',
    description: 'Shaped as your milestone number, layered in red velvet and cream-cheese silk.',
    flavours: ['Red Velvet', 'Classic Vanilla'],
    startingPrice: 7200,
    palette: 'ganache',
    image: 'https://images.pexels.com/photos/11112064/pexels-photo-11112064.jpeg?auto=compress&cs=tinysrgb&w=1200',
  },
  {
    id: 'bd-004',
  ...
  // Custom
  {
    ...
    category: 'custom',
    description: 'From a Pinterest board to a sketch to a tasting box \u2014 we design every detail around your vision.',
